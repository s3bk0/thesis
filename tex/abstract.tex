...
% Talk abstract
% In semiconductor qubits, the influence of heat transport by phonons originating
% in control electronics will play a significant role for the decoherence time of
% qubits in large scale quantum processors. This talk discusses the concept of a
% Bragg reflector for coherent reflection of thermal phonons in order to increase
% thermal isolation of semiconductor qubits. For that purpose, a numerical
% simulation tool was developed that can calculate the phonon transmission
% through such structures using the Transfer Matrix Method. The validity of the
% obtained results is demonstrated by comparing the results for known
% configurations