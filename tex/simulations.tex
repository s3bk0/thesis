...
\todo{Vielleicht schaffe ich hier noch nen den Fall mit einem einfallenden Winkel}

\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{Example2/L}
    \caption{Scattering of TH polarised waves at a single interface}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{Example2/TH.png}
    \caption{Scattering of TH polarised waves at a single interface}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{Example2/TV.png}
    \caption{Scattering of TV polarised waves at a single interface}
