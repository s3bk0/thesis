...
\begin{table}[t]
    ...
    \begin{tabular}{cccccc}
        ...
        $23=32
        \rightarrow 4$     & $13=31 \rightarrow 5$ & $12=21 \rightarrow 6$
    \end{tabular}
...
$\uline{p}_L$ is fixed to be $\uline{\vec{k}}_L$. If scattering at an interface
...
$\uline{p}_{TV}=\uline{\hat{k}}_T \cross \uline{p}_{TH}$. This arrangement is also
...
\begin{align}
    \uline{p}_L = \uline{\hat{k}}_L & = ( 0,\ \sin(\theta_L),\ -\cos(\theta_L)\
    )^T \ ,
    \\
    \uline{p}_{TH}                & = (\ 1,\ 0,\ 0)^T \ ,
    \\
    \uline{p}_{TV}                & = \uline{\hat{k}}_T \cross \uline{p}_{TH}
...
\end{equation}
\begin{equation}
    \begin{pmatrix} \underline{t}_n \\ \underline{r}_n \end{pmatrix}
= \underline{\underline{M}}_n ^{-1} \underline{\underline{M}}_{n-1} 
\begin{pmatrix} \underline{t}_{n-1} \\ \underline{r}_{n-1} \end{pmatrix} = \uuline{S}_n
\begin{pmatrix} \underline{t}_{n-1} \\ \underline{r}_{n-1} \end{pmatrix}
\end{equation}
...
\begin{equation}
    ...
    = S\cdot  \begin{pmatrix} \uline{t}_0 \\ \uline{r}_0 \end{pmatrix} =
    \begin{pmatrix}
        \uuline{T} & \uuline{C}_1 \\ \uuline{C}_2 & \uuline{R}
    \end{pmatrix} \cdot \begin{pmatrix} \uline{t}_0 \\ \uline{r}_0
    \end{pmatrix}.
\end{equation}
Remembering that $\uline{r_n}=0$, we can solve for $\uline{r}_1$ and
$\uline{t}_n$ and get
\begin{align} \label{eq:TMMcoeffsr}
    \uline{r}_0 & = -\uuline{R}^{-1}\ \uuline{C}_2\ \uline{t}_0     ,        \\
    \uline{t}_n & = \begin{pmatrix} \uuline{T},& \uuline{C}_1 \end{pmatrix}
    \cdot \begin{pmatrix} \uline{t}_0 \\ -\uuline{R}^{-1}\ \uuline{C}_2\
              \uline{t}_0\end{pmatrix} \label{eq:TMMcoeffst}.
\end{align}
%@appendix:
...
\begin{equation} \label{widthbandgap}
